...
def get_detector(detector):
    ...
    if isinstance(detector, str):
        ...
        # supported detector
        d = ['YOLO', 'RTDETR']
        assert detector.__class__.__name__ in d, f'detector should be an instance of {d}'
    return detector
    #except:
...
def get_reader(ocr_reader):
    ...
    if isinstance(ocr_reader, str):
        ...
        assert ocr_reader.__class__.__name__ in r, f'ocr_reader should be an instance of {r}' 
    return ocr_reader
